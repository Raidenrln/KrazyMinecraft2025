...
const UserInput = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-start p-4 bg-[url('/assets/background.png')] bg-cover bg-center bg-no-repeat">

      {/* search Bar */}
      <div className="w-full max-w-md flex flex-col sm:flex-row gap-2 mb-8 text-white">
        <input
          type="text"
          value={input}
