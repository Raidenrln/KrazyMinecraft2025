    ...
    <>
      <div className="mt-5">
        <div
          ref={summaryRef}
          className="
            w-[660px] h-[260px] p-4 rounded-xl flex relative overflow-hidden
            text-white shadow-2xl backdrop-blur-lg justify-center items-center
          "
        >
          {/* Background Image */}
          <div
            className="absolute inset-0 bg-cover bg-center opacity-40 -z-10"
            style={{ backgroundImage: "url('/KrazyMinecraft2025/minecraft-bg.png')" }}
          />
